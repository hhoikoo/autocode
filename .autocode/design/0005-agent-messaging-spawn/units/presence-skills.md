...
- `autocode/comms/skills/comms-register/SKILL.md`
- `autocode/comms/skills/comms-deregister/SKILL.md`
- `autocode/comms/skills/comms-agents/SKILL.md`

Shims:

- `plugins/autocode/skills/comms-register/SKILL.md`
- `plugins/autocode/skills/comms-deregister/SKILL.md`
- `plugins/autocode/skills/comms-agents/SKILL.md`

Skill names are globally unique (`comms-` prefix; not used by any existing feature-set).
...
`autocode/comms/skills/comms-register/test/smoke.sh`
