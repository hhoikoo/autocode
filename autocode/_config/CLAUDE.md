...
- `guides/` holds fixed, cross-cutting procedural specs that skills `@`-import (e.g. `worktree.md`). Plugin-internal: not scaffolded into target repos and not symlinked. See `guides/CLAUDE.md`.
